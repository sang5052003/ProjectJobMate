		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="mainnav-navbar-collapse">
				<ul class="nav navbar-nav navbar-default">
					...
					<li class="page-scroll"><a href="/recruit.html">채용관리</a></li>
					...
					<li class="page-scroll"><a href="/myscrap.html">내 스크랩</a></li>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-3 portfolio-item wow zoomIn">
					<img
						src="https://lh3.googleusercontent.com/-0ID1DL4bYac/VWYvNsdHh7I/AAAAAAAAAEM/QaQirN2iSO8/w600-h450-no/portfolio_01.png"
						class="img-responsive" alt="">
				</div>
				<div class="col-md-3 portfolio-item wow zoomIn">
					<img
						src="https://lh3.googleusercontent.com/-cvkoVynjpBk/VWYvNvYdCDI/AAAAAAAAAEA/1JKNpbQ_FPo/w600-h450-no/portfolio_02.jpg"
						class="img-responsive" alt="">
				</div>
				<div class="col-md-3 portfolio-item wow zoomIn">
					<img
						src="https://lh3.googleusercontent.com/-nNVWZNtKIwQ/VWYvNyRO2GI/AAAAAAAAAEI/p_Gm7eboXL4/w600-h450-no/portfolio_03.jpg"
						class="img-responsive" alt="">
				</div>
				<div class="col-md-3 portfolio-item wow zoomIn">
					<img
						src="https://lh3.googleusercontent.com/-CPazoZxaD7c/VWYvOQ1FzxI/AAAAAAAAAEQ/RcGN_2Mn4mU/w600-h450-no/portfolio_04.jpg"
						class="img-responsive" alt="">
				</div>
				<div class="col-md-3 portfolio-item wow zoomIn">
					<img
						src="https://lh3.googleusercontent.com/-3I31BpK6Erw/VlBzaSXFzrI/AAAAAAAAAHc/LiIsF4_mMas/s600-Ic42/portfolio_05.jpg"
						class="img-responsive" alt="">
				</div>
				<div class="col-md-3 portfolio-item wow zoomIn">
					<img
						src="https://lh3.googleusercontent.com/-LUqXKkYj7Mk/VlB0PLbyXgI/AAAAAAAAAIc/mcqIZTNRa7c/s600-Ic42/portfolio_06.jpg"
						class="img-responsive" alt="">
				</div>
				<div class="col-md-3 portfolio-item wow zoomIn">
					<img
						src="https://lh3.googleusercontent.com/-5S6eU4Rn5mQ/VlBzaVMvjGI/AAAAAAAAAHc/a2AtTAXmoi8/s600-Ic42/portfolio_07.jpg"
						class="img-responsive" alt="">
				</div>
				<div class="col-md-3 portfolio-item wow zoomIn">
					<img
						src="https://lh3.googleusercontent.com/-DySEOFLACag/VlBzaau6wrI/AAAAAAAAAHc/YVKSOTERFGM/s600-Ic42/portfolio_08.jpg"
						class="img-responsive" alt="">
				</div>
			</div>
		</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 text-center">
					...
					<p>Join me on my social networks for all the latest updates and
						more.</p>
					<ul class="list-inline text-center">
						<li><a href="#"
							class="btn-social btn-outline wow lightSpeedIn"><i
